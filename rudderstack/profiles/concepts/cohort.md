...
You can define cohorts in the [`profiles.yaml`](<https://www.rudderstack.com/docs/profiles/dev-docs/profiles-yaml/>) file, as shown:
...
## Best practices
  ...
  * A child cohort inherits all the features from their parent and can have features and [feature views](<https://www.rudderstack.com/docs/profiles/concepts/feature-views/>) defined at the individual cohort level.

  


  * [![](/docs/images/previous.svg)Previous](</docs/profiles/concepts/feature-views/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/concepts/timegrains/>)