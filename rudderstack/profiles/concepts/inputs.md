...
You can define `inputs` in the [`inputs.yaml`](<https://www.rudderstack.com/docs/profiles/dev-docs/inputs-yaml/>) file, as shown:
...
## Best practices
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/profiles/concepts/identity-graph/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/concepts/features/>)