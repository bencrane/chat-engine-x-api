...
This dataset contains a total of ~10k unique users by `anonymousId`. About 5.8k of these unique users are known users (with an associated `identify` call).
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/profiles/additional-resources/multi-version/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/additional-resources/git-url/>)