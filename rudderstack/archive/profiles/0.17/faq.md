...
Profiles support git branches in the RudderStack dashboard. Refer [Supported Git URLs](<https://www.rudderstack.com/docs/archive/profiles/0.17/additional-concepts/packages/#supported-git-urls>) for more information.
...
Yes, refer to the [YAML best practices](<https://www.rudderstack.com/docs/archive/profiles/0.17/resources/yaml-refresher/>) guide for detailed information.
...
You can run Profiles in the RudderStack dashboard or via [Profile Builder CLI](<https://www.rudderstack.com/docs/archive/profiles/0.17/get-started/profile-builder/>).
...
You need to follow a different format for `gitcreds:` in siteconfig. See [SiteConfiguration](<https://www.rudderstack.com/docs/archive/profiles/0.17/cli-user-guide/structure/#site-configuration-file-configuration.md>) for the format.
...
You can check for the latest Profiles updates in the [changelog](<https://www.rudderstack.com/docs/archive/profiles/0.17/changelog/>).
...
See [Supported Git URLs](<https://www.rudderstack.com/docs/archive/profiles/0.17/additional-concepts/packages/#supported-git-urls>) for more information.
...
A sample `profiles.yaml` file highlighted a disabled model:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.17/changelog/profiles-0.1-changelog/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.17/resources/>)