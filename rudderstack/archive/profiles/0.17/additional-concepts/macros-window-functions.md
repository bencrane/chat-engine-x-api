...
Note how `frame_clause` is specified in first `entity_var` and not in the second one.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.17/additional-concepts/multi-version/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.17/additional-concepts/input-sources/>)