...
Make sure that the version of Profiles project is the same in your environment and the `pb_project.yaml` file. Otherwise, RudderStack will throw an error.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.17/additional-concepts/manage-models/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.17/additional-concepts/macros-window-functions/>)