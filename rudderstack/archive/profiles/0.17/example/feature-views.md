...
## Prerequisites
  ...
  * [Identity Stitching](<https://www.rudderstack.com/docs/archive/profiles/0.17/example/id-stitcher/>) model as Feature View reuses its output to extract the required features/traits.
...
The `feature_view` model is almost an exact replica of the [entity var table](<https://www.rudderstack.com/docs/archive/profiles/0.17/core-concepts/feature-development/#feature-creation-models>) in a view format. The only difference is that:
...
![Generated table \(Snowflake\)](/docs/images/profiles/profiles-feature-table.webp)
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.17/example/feature-table/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.17/example/sql-model/>)