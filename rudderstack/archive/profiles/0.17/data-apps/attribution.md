...
This section guide assumes you have already [created a business entity](<https://www.rudderstack.com/docs/archive/profiles/0.17/cli-user-guide/structure/#project-details>) (like `user`) and an [ID stitcher model](<https://www.rudderstack.com/docs/archive/profiles/0.17/example/id-stitcher/>) for that entity as part of an existing Profiles project.
...
If you define multiple conversions, the `[CONVERSION_TYPE]_` columns are repeated for each conversion, for example, `signup_first_touch_count`, `subscribed_first_touch_count`, etc.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.17/data-apps/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.17/data-apps/propensity/>)