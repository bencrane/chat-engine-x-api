...
`type`  
Required| `id_type` from the list of `id_types` in the `entity` section of [`pb_project.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.24/dev-docs/pb-project-yaml/>).  
`entity`  
...
### Example
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.24/dev-docs/inputs-yaml/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.24/dev-docs/inputs-yaml/s3-bucket-input/>)