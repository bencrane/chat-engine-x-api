...
## Best practices
  ...
  * Every `entity_var` is included in [`feature_views`](<https://www.rudderstack.com/docs/archive/profiles/0.24/concepts/feature-views/>) by default.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.24/concepts/inputs/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.24/concepts/feature-views/>)