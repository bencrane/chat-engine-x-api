...
You can explore other project settings in the different tabs. For more information, see [Project details](<https://www.rudderstack.com/docs/archive/profiles/0.14/get-started/quickstart-ui/#project-details>).

> ![warning](/docs/images/warning.svg)
> 
> Once you import a project successfully in the dashboard, you cannot edit its Git repository URL.

  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.14/get-started/quickstart-ui/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.14/get-started/sample-data/>)