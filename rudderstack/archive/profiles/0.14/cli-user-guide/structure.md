...
The `inputs.yaml` file lists all the input sources which should be used to run models and eventually create outputs. You can also define specific constraints on the input sources using the [`contract`](<https://www.rudderstack.com/docs/archive/profiles/0.14/example/packages/#model-contracts>) key.
...
The `README.md` file provides a quick overview on how to use PB along with SQL queries for data analysis.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.14/cli-user-guide/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.14/cli-user-guide/commands/>)