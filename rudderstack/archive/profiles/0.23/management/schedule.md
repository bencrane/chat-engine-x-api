...
Once you have [imported your Profiles project from Git repository](<https://www.rudderstack.com/docs/archive/profiles/0.23/management/import-from-git/>) in the RudderStack app, you can schedule it to run at the specified frequency and time interval.
...
[![Schedule Profiles project run manually](/docs/images/profiles/profiles-run-manual.webp)](</docs/images/profiles/profiles-run-manual.webp>)
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/management/import-from-git/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/management/activations/>)