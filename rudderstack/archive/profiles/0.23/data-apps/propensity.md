...
> 
> RudderStack strongly recommends using an isolated and clean [Python virtual environment](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/create-new-project/#create-virtual-environment>).
...
If you have created your Profiles project locally, run it using the [`pb run` CLI command](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/run-project/>) to generate the output tables.
...
If your model’s performance is unsatisfactory, consider these improvement strategies:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/data-apps/attribution/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/data-apps/real-time-personalization/>)