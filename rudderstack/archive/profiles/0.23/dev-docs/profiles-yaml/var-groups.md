...
You can `var_groups` in the [`profiles.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/profiles-yaml/>) file:
...
[`input_var`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/profiles-yaml/var-groups/input-var/>)| Input variable configuration.  
[`entity_var`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/profiles-yaml/var-groups/entity-var/>)| Entity variable configuration.  
...
## Example
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/dev-docs/profiles-yaml/id-stitcher/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/dev-docs/profiles-yaml/var-groups/input-var/>)