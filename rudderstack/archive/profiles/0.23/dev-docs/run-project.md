...
This command generates and runs the SQL files in the warehouse, creating the material tables.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/dev-docs/id-graph-rules/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/dev-docs/warehouse-output/>)