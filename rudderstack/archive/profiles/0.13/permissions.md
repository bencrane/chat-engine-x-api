...
Alternatively, you can add the following **IAM Policy Binding** :
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.13/core-concepts/feature-development/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.13/cli-user-guide/>)