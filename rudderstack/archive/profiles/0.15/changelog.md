...
**Known Issues**
  ...
  * When using the CLI: You will have to manually make changes in the [`siteconfig.yaml` file](<https://www.rudderstack.com/docs/archive/profiles/0.15/cli-user-guide/structure/#site-configuration-file>) to add a Snowflake connection with key-pair authentication.
...
**Known Issues:**
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.15/additional-concepts/run-process/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.15/changelog/profiles-0.15.x-changelog/>)