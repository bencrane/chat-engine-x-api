...
A sample code is as shown:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.15/additional-concepts/macros-window-functions/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.15/additional-concepts/input-entity-var/>)