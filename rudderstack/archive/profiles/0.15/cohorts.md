...
Run your [Profiles CLI project](<https://www.rudderstack.com/docs/archive/profiles/0.15/get-started/profile-builder/>) using the `pb run` command to generate output tables.

### Profiles UI

To view cohorts in the RudderStack dashboard, you can make your Profiles CLI project available in a Git repository and import it in the RudderStack dashboard. See [Import Profiles Project from Git](<https://www.rudderstack.com/docs/archive/profiles/0.15/get-started/import-from-git/>) for more information.
...
You can further activate your cohorts data by syncing it to the downstream destinations. See [Activations](<https://www.rudderstack.com/docs/archive/profiles/0.15/activations/>) for more information.

  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.15/predictions/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.15/activations/>)