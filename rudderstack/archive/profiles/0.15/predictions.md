...
Predictions extends Profiles’ standard [feature development](<https://www.rudderstack.com/docs/archive/profiles/0.15/core-concepts/feature-development/>) functionality. It lets you easily create predictive features in your warehouse and answer questions like:
...
The following self-guided tour shows you how to build the predictive traits. You can also follow the [Predictions sample project](<https://www.rudderstack.com/docs/archive/profiles/0.15/example/predictive-features-snowflake/>) guide and build the project yourself, including sample data.
...
> 
> If you want to run your python model locally using a [CLI setup](<https://www.rudderstack.com/docs/archive/profiles/0.15/get-started/profile-builder/>), you must set up a python environment with the required packages and add the python path to your [siteconfig.yaml](<https://www.rudderstack.com/docs/archive/profiles/0.15/cli-user-guide/structure/#site-configuration-file-configuration.md>) file.
...
### Prerequisites
  ...
  * You must set up a standard Profiles project with a [feature table model](<https://www.rudderstack.com/docs/archive/profiles/0.15/example/feature-table/>).
...
Follow the [Feature table](<https://www.rudderstack.com/docs/archive/profiles/0.15/example/feature-table/>) guide to create a Profiles project. Your project must include the definition of the feature you want to predict.
...
If you have created your Predictions Profiles project locally, run it using the `pb run` [CLI](<https://www.rudderstack.com/docs/archive/profiles/0.15/get-started/profile-builder/>) command to generate output tables.
...
Run your Predictions Profiles project by first uploading it to a Git repository and then [importing it in the RudderStack dashboard](<https://www.rudderstack.com/docs/archive/profiles/0.15/get-started/import-from-git/#steps>).
...
Once your project run is completed, you can:
  ...
  * Check the predicted value for any given user in the RudderStack dashboard’s [Profile Lookup](<https://www.rudderstack.com/docs/archive/profiles/0.15/get-started/quickstart-ui/#profile-details>) section.
...
## See Also
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.15/cli-user-guide/commands/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.15/cohorts/>)