...
A sample code is as shown:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.18/additional-concepts/packages/id-types/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.18/additional-concepts/input-entity-var/>)