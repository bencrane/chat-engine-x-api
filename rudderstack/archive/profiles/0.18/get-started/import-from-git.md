...
> 
> You cannot edit this Git repository URL afterwards.
...
You can explore other project settings in the different tabs. For more information, see [Project details](<https://www.rudderstack.com/docs/archive/profiles/0.18/get-started/quickstart-ui/#project-details>).

  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.18/get-started/quickstart-ui/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.18/get-started/sample-data/>)