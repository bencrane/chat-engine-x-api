...
The default `feature_view` model is almost an exact replica of the [entity var table](<https://www.rudderstack.com/docs/archive/profiles/0.16/core-concepts/feature-development/#feature-creation-models>) in a view format. The only difference is that:
...
![Generated table \(Snowflake\)](/docs/images/profiles/profiles-feature-table.webp)
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.16/example/feature-table/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.16/example/sql-model/>)