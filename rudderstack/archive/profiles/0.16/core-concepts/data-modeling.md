...
When you run the Profiles project, it creates an identity graph and feature view as outputs. You can augment the graph and create new user features by writing simple definitions in a configuration file or via SQL models.
...
To implement advanced use cases, you can use [custom SQL queries](<https://www.rudderstack.com/docs/archive/profiles/0.16/example/sql-model/>) to define user features.
...
By leveraging cohorts, you can target specific customer segments by enabling targeted campaigns and analysis. See [Cohorts](<https://www.rudderstack.com/docs/profiles/cohorts/>) for more information.

  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.16/core-concepts/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.16/core-concepts/identity-stitching/>)