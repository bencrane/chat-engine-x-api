...
This command generates and runs the SQL files in the warehouse, creating the material tables.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.19/dev-docs/macros-yaml/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.19/dev-docs/warehouse-output/>)