...
See the [Profiles ID Stitcher Audit tool](<https://www.rudderstack.com/docs/archive/profiles/0.19/additional-resources/profiles-audit/>) guide for more information.
...
Shows the Profile Builder’s current version along with its GitHash and native schema version.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.19/dev-docs/activation-api/v1/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.19/dev-docs/yaml-refresher/>)