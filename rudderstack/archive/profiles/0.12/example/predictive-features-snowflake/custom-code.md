...
[![Predictive features in Snowflake](/docs/images/profiles/predictive-features-snowflake/final-table.webp)](</docs/images/profiles/predictive-features-snowflake/final-table.webp>)
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.12/example/predictive-features-snowflake/setup-automated-features/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.12/example/packages/>)