...
For example, `CREATE OR REPLACE {{this.GetMaterialization().OutputType.ToSQL()}} {{this.GetSelectTargetSQL()}} AS ...`
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.12/example/entity-traits-360/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.12/example/predictive-features-snowflake/>)