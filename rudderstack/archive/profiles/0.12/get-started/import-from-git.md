...
You can explore other project settings in the different tabs. For more information, see [Profile details](<https://www.rudderstack.com/docs/archive/profiles/0.12/get-started/quickstart-ui/#profile-details>).

  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.12/get-started/quickstart-ui/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.12/get-started/sample-data/>)