...
To implement advanced use cases, you can use [custom SQL queries](<https://www.rudderstack.com/docs/archive/profiles/0.12/example/sql-model/>) to define user features.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.12/core-concepts/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.12/core-concepts/identity-stitching/>)