...
> 
> For queries or issues not listed in this guide, contact [RudderStack Support](<mailto:support@rudderstack.com>).
...
Profiles UI only supports the repos hosted on GitHub currently.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.10/snowflake-quickstart/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/dashboard-guides/>)