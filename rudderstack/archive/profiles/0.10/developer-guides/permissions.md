...
To give access to only specific input tables/views referred in your Profiles project, use the below command:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.10/developer-guides/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.10/developer-guides/site-configuration/>)