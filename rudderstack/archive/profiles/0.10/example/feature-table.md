# Entity Traits 360 / Feature Table
...
`features`| String| Specifies the list of `name` in `entity_var`, that must act as a feature.  
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.10/example/id-collator/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.10/example/sql-model/>)