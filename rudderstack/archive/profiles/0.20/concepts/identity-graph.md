...
Multiple identities is the biggest obstacle to getting a full picture of your customers, user, or any other [`entity`](<https://www.rudderstack.com/docs/archive/profiles/0.20/concepts/entities/>).
...
## Requirements
  ...
  * Defined [`id_types`](<https://www.rudderstack.com/docs/archive/profiles/0.20/dev-docs/pb-project-yaml/id-types/>) for your entity and mapped to your input sources.


## Usage

The identity graph is located in the [`profiles.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.20/dev-docs/profiles-yaml/>) file as an `id_stitcher` model.
...
## Best practices
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.20/concepts/id/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.20/concepts/inputs/>)