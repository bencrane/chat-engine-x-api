...
## Prerequisites
  ...
  * Generate a [workspace-level Service Access Token](<https://www.rudderstack.com/docs/access-management/service-access-tokens/#workspace-sat>) in your RudderStack workspace. Then, add it to your [site configuration file](<https://www.rudderstack.com/docs/archive/profiles/0.20/dev-docs/site-configuration-file/>).
...
#### How do I resolve the Python package-related issues when running the pb audit command?
...
#### How do I resolve the error `rpc init: timeout waiting for python client to initialize` when running the audit command?

Audit is a PyNative model written in Python. Python code is first compiled into bytecode and is executed by the Python interpreter. Sometimes, compiling Python code takes more time than expected.
...
You can keep retrying the command and the error should resolve on its own.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.20/dev-docs/activation-api/v1/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.20/dev-docs/commands/>)