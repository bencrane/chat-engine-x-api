...
> 
> RudderStack also supports SIGNL4 as a destination. Refer to the [SIGNL4 destination documentation](<https://www.rudderstack.com/docs/destinations/streaming-destinations/signl4/>) for more information.
...
[![SIGNL4 source webhook URL](/docs/images/event-stream-sources/source-webhook-url.webp)](</docs/images/event-stream-sources/source-webhook-url.webp>)
...
[![SIGNL4 source webhook URL](/docs/images/event-stream-sources/signl4-source-webhook.webp)](</docs/images/event-stream-sources/signl4-source-webhook.webp>)
