...
## Get started
  ...
  3. Your Refiner source is now configured. Go to the **Settings** tab of the source and note the **Webhook URL** :

[![Refiner source webhook URL](/docs/images/event-stream-sources/source-webhook-url.webp)](</docs/images/event-stream-sources/source-webhook-url.webp>)

  4. Log in to your [Refiner account](<https://app.refiner.io/auth/login>).
...
[![Refiner source webhook URL](/docs/images/event-stream-sources/refiner-dashboard-webhook.webp)](</docs/images/event-stream-sources/refiner-dashboard-webhook.webp>)
