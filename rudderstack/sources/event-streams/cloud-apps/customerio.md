...
> To connect this source to a RudderStack warehouse destination, the source name should match the name of your warehouse schema.
  ...
  3. Your Customer.io source is now configured. Go to the **Settings** tab of the source and note the **Webhook URL** :
...
[![Customer.io reporting webhooks](/docs/images/event-stream-sources/customerio-3.webp)](</docs/images/event-stream-sources/customerio-3.webp>)
...
`Subscribed`| The customer subscribed via a particular email.  
...
[![Customer.io event settings](/docs/images/event-stream-sources/customerio-5.webp)](</docs/images/event-stream-sources/customerio-5.webp>)
