...
## Get started
  ...
  3. Your Olark source is now configured. Go to the **Settings** tab of the source and note the **Webhook URL** :

[![Olark source webhook URL](/docs/images/event-stream-sources/source-webhook-url.webp)](</docs/images/event-stream-sources/source-webhook-url.webp>)
...
`visitor.operatingSystem`| `context.browser.name`  
