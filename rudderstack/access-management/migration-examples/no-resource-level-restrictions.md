...
Example of how migration works when users and Service Access Tokens have no resource-level permission restrictions in their access policy.
...
The examples in this guide show how migration works when a user **does not have** any [resource-level permissions](<https://www.rudderstack.com/docs/archive/dashboard-guides/permissions-management/#restricting-edit-permissions-for-individual-objects>) configured as a part of their role in the [legacy Permissions Management (RBAC) system](<https://www.rudderstack.com/docs/archive/dashboard-guides/user-management/#role-permissions>).

> ![info](/docs/images/info.svg)
> 
> **Important: Service Access Tokens Migration**
> 
> The migration examples in this guide also apply to [Service Access Tokens](<https://www.rudderstack.com/docs/archive/dashboard-guides/service-access-tokens/>) created in the [legacy RBAC system](<https://www.rudderstack.com/docs/archive/dashboard-guides/service-access-tokens/#generate-service-access-token>).
> 
...
[![](/docs/images/access-management/migration/connections-admin-resources-post-migration.webp)](</docs/images/access-management/migration/connections-admin-resources-post-migration.webp>)[![](/docs/images/access-management/migration/connections-admin-pii-post-migration.webp)](</docs/images/access-management/migration/connections-admin-pii-post-migration.webp>)
...
[![Migration example showing new permissions model for resources](/docs/images/access-management/migration/connections-editor-resources-post-migration.webp)](</docs/images/access-management/migration/connections-editor-resources-post-migration.webp>)[![Migration example showing new permissions model for PII](/docs/images/access-management/migration/connections-editor-pii-post-migration.webp)](</docs/images/access-management/migration/connections-editor-pii-post-migration.webp>)
...
[![](/docs/images/access-management/migration/connections-viewer-pre-migration-permissions.webp)](</docs/images/access-management/migration/connections-viewer-pre-migration-permissions.webp>)
...
[![Migration example showing new permissions model for resources](/docs/images/access-management/migration/connections-viewer-resources-post-migration.webp)](</docs/images/access-management/migration/connections-viewer-resources-post-migration.webp>)[![Migration example showing new permissions model for PII](/docs/images/access-management/migration/connections-viewer-pii-post-migration.webp)](</docs/images/access-management/migration/connections-viewer-pii-post-migration.webp>)
