...
Set up and configure Movable Ink as a destination in RudderStack.
...
---  
  ...
  * Refer to it as **Movable Ink** in the [Integrations object](</docs/sources/event-streams/sdks/rudderstack-javascript-sdk/filtering/#filtering-destinations>).
...
Access Key| Enter the access key from your endpoint details.  
Access Secret| Enter the access secret from your endpoint details.  
...
## Next steps
  ...
  * [Send events in cloud mode](<https://www.rudderstack.com/docs/destinations/streaming-destinations/movable-ink/cloud-mode/>)
...
[![Movable Ink public key](/docs/images/event-stream-destinations/movable-ink.webp)](</docs/images/event-stream-destinations/movable-ink.webp>)