...
[![](/docs/images/source%20%281%29.webp)](</docs/images/source%20%281%29.webp>)
...
## Using the Query string API

RudderStack’s Query string API allows you to trigger `track`, `identify` calls using query parameters.
