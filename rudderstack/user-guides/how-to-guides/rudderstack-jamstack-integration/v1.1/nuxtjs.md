...
[![Nuxt.js configuration](/docs/images/user-guides/nuxtjs-config.webp)](</docs/images/user-guides/nuxtjs-config.webp>)

> ![info](/docs/images/info.svg)
> 
> See the sample Nuxt app in the [RudderStack Sample Applications](<https://github.com/rudderlabs/rudder-samples/tree/master/javascript/sample-nuxt-app>) repository for more information.
