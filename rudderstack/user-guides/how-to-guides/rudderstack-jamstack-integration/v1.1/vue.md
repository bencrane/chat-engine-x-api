# Integrate JavaScript SDK v1.1 with your Vue app
...
To set up the event stream on your Vue app, you need to perform the following steps:
  ...
  1. Integrate the JavaScript SDK with your Vue app and set up the tracking code
...
Integrating the JavaScript SDK with your Vue app involves the following steps:
  ...
  2. Installing and configuring the JavaScript SDK in your Vue app
...
> 
> See the sample Vue app in the [RudderStack Sample Applications](<https://github.com/rudderlabs/rudder-samples/tree/master/javascript/sample-vue-app>) repository for more information.
