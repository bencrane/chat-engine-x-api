# Integrate JavaScript SDK v1.1 with your Ember.js app
...
To set up the event stream on your Ember.js app, you need to perform the following steps:
  ...
  1. Integrate the JavaScript SDK with your Ember.js app and set up the tracking code
  2. Configure a destination in RudderStack
  3. Deploy your Ember.js app and verify the events
...
Integrating the JavaScript SDK with your Ember.js app involves the following steps:
  ...
  2. Installing and configuring the JavaScript SDK in your app
...
> 
> See the sample Ember.js app in the [RudderStack Sample Applications](<https://github.com/rudderlabs/rudder-samples/tree/master/javascript/sample-emberjs-app>) repository for more information.
