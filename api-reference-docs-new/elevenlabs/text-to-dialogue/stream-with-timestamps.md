        ...
        '200':
          ...
          content:
            text/event-stream:
              schema:
                $ref: >-
                  #/components/schemas/type_:StreamingAudioChunkWithTimestampsAndVoiceSegmentsResponseModel
        '422':
            ...
            schema:
              ...
              properties:
                ...
                apply_text_normalization:
                  $ref: >-
                    #/components/schemas/type_textToDialogue:BodyTextToDialogueStreamWithTimestampsApplyTextNormalization
                  description: >-
...
components:
  schemas:
    ...
    type_textToDialogue:BodyTextToDialogueStreamWithTimestampsApplyTextNormalization:
      type: string
      enum:
        - auto
        - 'on'
      ...
      description: >-
        ...
        it will be skipped.
      title: BodyTextToDialogueStreamWithTimestampsApplyTextNormalization
    ...
    type_:VoiceSegment:
      ...
      required:
        ...
        - dialogue_input_index
      title: VoiceSegment
    type_:StreamingAudioChunkWithTimestampsAndVoiceSegmentsResponseModel:
      type: object
      properties:
        audio_base64:
          type: string
...
func main() {
	...
	url := "https://api.elevenlabs.io/v1/text-to-dialogue/stream/with-timestamps?output_format=mp3_22050_32"
...
url = URI("https://api.elevenlabs.io/v1/text-to-dialogue/stream/with-timestamps?output_format=mp3_22050_32")
...
HttpResponse<String> response = Unirest.post("https://api.elevenlabs.io/v1/text-to-dialogue/stream/with-timestamps?output_format=mp3_22050_32")
...
$response = $client->request('POST', 'https://api.elevenlabs.io/v1/text-to-dialogue/stream/with-timestamps?output_format=mp3_22050_32', [
  'body' => '{
  "inputs": [
    {
      "text": "Hello, how are you?",
...
var client = new RestClient("https://api.elevenlabs.io/v1/text-to-dialogue/stream/with-timestamps?output_format=mp3_22050_32");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.elevenlabs.io/v1/text-to-dialogue/stream/with-timestamps?output_format=mp3_22050_32")! as URL,
