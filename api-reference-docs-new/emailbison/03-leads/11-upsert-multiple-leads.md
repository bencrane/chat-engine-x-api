...
info:
  ...
  version: 1.0.0
paths:
  /api/leads/create-or-update/multiple:
    post:
      summary: Update or create multiple leads
      deprecated: false
      description: >-
            ...
            schema:
              ...
              properties:
                existing_lead_behavior:
                  type: string
                  description: >-
                    The behavior to apply when a lead already exists.
                      ...
                      custom_variables:
                        ...
                        items:
                          ...
                          properties:
                            name:
                              type: string
                              description: 'The name of the custom variable field.'
