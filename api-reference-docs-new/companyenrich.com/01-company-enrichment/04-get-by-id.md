...
Gets company information by its CompanyEnrich ID. You can obtain this ID by calling the Enrich endpoint or other endpoints that return company information.
...
|-----------|------|----------|-------------|
| `id`      | uuid | Yes      | The CompanyEnrich ID of the company |
