# Company Similar - Find Similar Companies
...
|---|---|---|
| `domain` | string \| null | The domain to find similar companies for. **Deprecated** — use `domains` instead. Using `domains` with a single domain acts the same as using this parameter |
| `page` | int32 | The page number to return. Must be greater than 0 |
| `pageSize` | int32 (1–100) | The number of results to return. Must be between 1 and 100 |
