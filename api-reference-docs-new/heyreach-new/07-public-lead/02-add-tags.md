...
**Endpoint:** `https://api.heyreach.io/api/public/lead/AddTags`

Add Tags to Lead.

Adds tags to the lead. Existing tags will not be changed.
...
```bash
curl --location 'https://api.heyreach.io/api/public/lead/AddTags' \
