...
```
POST https://api.heyreach.io/api/public/list/AddLeadsToList
```

Add leads to a lead list. Add up to 100 leads per request.
...
```bash
curl --location 'https://api.heyreach.io/api/public/list/AddLeadsToList' \
