...
**Endpoint:** `https://api.heyreach.io/api/public/campaign/AddLeadsToCampaignV2`

Add leads to a campaign. Add up to 100 leads per request. If a LinkedIn account Id is specified in the `AccountLeadPairs`, that lead will be mapped to the account in the campaign. Same as the `AddLeadsToCampaign` request, however this request returns counts for how many of the leads were added, how many were updated, and how many failed to be added.
...
```bash
curl --location 'https://api.heyreach.io/api/public/campaign/AddLeadsToCampaignV2' \
