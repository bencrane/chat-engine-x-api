...
[![Canny source webhook URL](/docs/images/event-stream-sources/source-webhook-url.webp)](</docs/images/event-stream-sources/source-webhook-url.webp>)

  4. Log in to your [Canny account](<https://canny.io/login>). In the top-right side, select the **Settings** option under your profile followed by **API & Webhooks**.
  5. Enter the **Webhook URL** under **Webhooks** section:

[![Canny source webhook URL](/docs/images/event-stream-sources/webhook-url-canny.webp)](</docs/images/event-stream-sources/webhook-url-canny.webp>)
