# Create Profiles Project in the RudderStack dashboard
...
This guide lists the steps to create a Profiles project in the RudderStack dashboard.
...
[![Web-based Editor method for creating Profiles project](/docs/images/profiles/web-based-editor.webp)](</docs/images/profiles/web-based-editor.webp>)

> ![info](/docs/images/info.svg)
> 
> You can also import an existing project from your Git repository.
...
[![](/docs/images/profiles/profiles-ide.webp)](</docs/images/profiles/profiles-ide.webp>)
  ...
  9. Edit the YAML files and [save and commit the changes](<https://www.rudderstack.com/docs/profiles/dev-docs/ide/#what-is-the-difference-between-the-save-and-commit-operations>) to your project.
  10. Click the **Run** button to run the project. Upon successful completion, you can view the outputs in your data warehouse.


### Convert to a Git project

Once you set up a Profiles project in the dashboard, you can convert it to a configuration-based Git repository by [uploading it either to GitHub, GitLab, or Bitbucket](<https://www.rudderstack.com/docs/profiles/dev-docs/ide/#which-git-urls-does-the-profiles-ide-support>):
...
Once downloaded, you can view the [project folder structure](<https://www.rudderstack.com/docs/profiles/dev-docs/project-structure/>), modify the files, or run various [commands](<https://www.rudderstack.com/docs/profiles/dev-docs/commands/>) to execute the desired use-cases.

## Project details

To view the Profiles project details, click the arrow icon corresponding to your Profiles project:
...
**Alerts**|  Set up [Alert thresholds](<https://www.rudderstack.com/docs/data-governance/alerts/#profiles>) for the Profiles project  
...
You can also view the details of a specific profile in your Profiles project:
  ...
  3. Type an available unique identifier like `email`, `phone number`, `user id`, `anonymous id`, or the entity’s `main_id` (for example, `user_main_id`) and click **Search user profile**.


[![Activation API](/docs/images/profiles/profiles-lookup.webp)](</docs/images/profiles/profiles-lookup.webp>)
...
>   * If you keep getting a blank screen, it may be because you do not have sufficient access. Make sure you have the [relevant permissions](<https://www.rudderstack.com/docs/profiles/overview/quickstart/#required-permissions>) with the ability to access PII. In case the problem persists, contact [RudderStack support](<mailto:support@rudderstack.com>).
> 


  * [![](/docs/images/previous.svg)Previous](</docs/profiles/overview/quickstart/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/concepts/>)