...
You can use Profiles to [stitch together](<https://www.rudderstack.com/docs/profiles/concepts/identity-graph/>) both known and unknown IDs into a single table. The IDs are linked using an autogenerated ID, called the `rudderId`, which is a canonical identifier for each user.
...
[![Features generation](/docs/images/profiles/features-generation.png)](</docs/images/profiles/features-generation.png>)
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/profiles/overview/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/overview/quickstart/>)