...
You can define macros in the `macros.yaml` file in the model folder, and call them within any other [`profiles.yaml`](<https://www.rudderstack.com/docs/profiles/dev-docs/profiles-yaml/>) file.
...
## Example
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/profiles/dev-docs/sql-model-yaml/sql-model-config/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/dev-docs/incremental-features/>)