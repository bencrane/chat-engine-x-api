...
> `pip3 install profiles-rudderstack==0.25.0b5`
  ...
  * Generate a [workspace-level Service Access Token](<https://www.rudderstack.com/docs/access-management/service-access-tokens/#workspace-sat>) in your RudderStack workspace. Then, add it to your [site configuration file](<https://www.rudderstack.com/docs/profiles/dev-docs/site-configuration-file/>).
...
If you are on the [legacy Permissions Management (RBAC) system](<https://www.rudderstack.com/docs/archive/dashboard-guides/user-management/>), your workspace-level Service Access Token should have minimum **Viewer** permission.
...
See the FAQs on [Python-related errors](<https://www.rudderstack.com/docs/profiles/additional-resources/faq/#python-related-errors>) for more information.

  


  * [![](/docs/images/previous.svg)Previous](</docs/profiles/dev-docs/activation-api/v1/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/dev-docs/commands/>)