...
Validate Profile Builder’s version after installing:
  ...
  * If you are an existing user, [migrate your project](<https://www.rudderstack.com/docs/profiles/dev-docs/commands/#migrate>) to the new schema.
  * See the [Profiles setup and installation FAQ](<https://www.rudderstack.com/docs/profiles/additional-resources/faq/#setup-and-installation>) for troubleshooting any issues.
...
Then, assign the dataset or project level roles to your service account:
  ...
  3. Select the dataset to which you want to grant access.
...
Then, continue with the connection setup by specifying the below settings:
  ...
  * **Append to site configuration file** : Determines whether to add the connection details to the [`siteconfig.yaml`](<https://www.rudderstack.com/docs/profiles/dev-docs/site-configuration-file/>) file.
...
A sample connection for a BigQuery account is as follows:
  ...
  * **Connection Name** : Name of the connection in the project file.
  * **Target** : Environment name, such as `dev`, `prod`, `test`, etc. You can specify any target name and create a separate connection for the same.
  * **Credentials** : File path of your BigQuery JSON credentials file.
  * **project_id** : Your Google Cloud project ID.
  * **Dataset** : Name of the dataset where the output tables/views created by Profiles will be stored.
  * **Append to site configuration file** : Determines whether to add the connection details to the [`siteconfig.yaml`](<https://www.rudderstack.com/docs/profiles/dev-docs/site-configuration-file/>) file.


This creates a local [site configuration file](<https://www.rudderstack.com/docs/profiles/dev-docs/site-configuration-file/>) in your home directory: `~/.pb/siteconfig.yaml`. Your Profiles project uses this file to access the warehouse, Git credentials, and other details. If you don’t see the file, enable the **View hidden files** option.
...
See [Project structure](<https://www.rudderstack.com/docs/profiles/dev-docs/project-structure/>) for more information on the Profiles project files.

  


  * [![](/docs/images/previous.svg)Previous](</docs/profiles/dev-docs/profiles-tutorial/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/dev-docs/project-structure/>)