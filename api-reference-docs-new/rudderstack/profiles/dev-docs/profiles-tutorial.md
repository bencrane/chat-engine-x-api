...
> `pip3 install profiles-rudderstack==0.25.0b5`
  ...
  * [Create a warehouse connection](<https://www.rudderstack.com/docs/profiles/overview/quickstart/#2-create-warehouse-connection>) file that Profiles uses to access your warehouse. This creates a local site configuration file inside your home directory: `~/.pb/siteconfig.yaml`.
...
Once you exit the tutorial session and want to begin a a new Profiles project with your own data, follow this [Quickstart guide](<https://www.rudderstack.com/docs/profiles/overview/quickstart/>) to get started.

## FAQ

In addition to the below FAQs, see the FAQs on [Python-related errors](<https://www.rudderstack.com/docs/profiles/additional-resources/faq/#python-related-errors>) for more information on debugging issues related to running the tutorial.
...
The materialized tables and views will output to the same target schema configured in the site configuration/connection setup step.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/profiles/dev-docs/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/dev-docs/create-new-project/>)