...
Window functions are SQL functions that you can use with [`input_vars`](<https://www.rudderstack.com/docs/profiles/dev-docs/profiles-yaml/var-groups/input-var/>) and [`entity_vars`](<https://www.rudderstack.com/docs/profiles/dev-docs/profiles-yaml/var-groups/entity-var/>).
...
## Example
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/profiles/dev-docs/profiles-yaml/var-groups/input-var/>)
  * [Next ![](/docs/images/next.svg)](</docs/profiles/dev-docs/profiles-yaml/cohorts/>)