...
Set up and configure Cordial as a destination in RudderStack.
...
---  
  ...
  * Refer to it as **Cordial** in the [Integrations object](</docs/sources/event-streams/sdks/rudderstack-javascript-sdk/filtering/#filtering-destinations>).
...
API Base URL| Specify the API base URL by going to in your Cordial dashboard. For example, `https://api.usw2.cordial.io`.  
...
## Next steps
  ...
  * [Send events in cloud mode](<https://www.rudderstack.com/docs/destinations/streaming-destinations/cordial/cloud-mode/>)
...
[![Cordial API base URL](/docs/images/event-stream-destinations/cordial-api-base-url.webp)](</docs/images/event-stream-destinations/cordial-api-base-url.webp>)