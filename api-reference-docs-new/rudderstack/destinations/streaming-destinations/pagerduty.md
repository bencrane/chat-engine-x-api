...
---  
  ...
  * Refer to it as **PagerDuty** in the [Integrations object](</docs/sources/event-streams/sdks/rudderstack-javascript-sdk/filtering/#filtering-destinations>).
...
[![PagerDuty integration key](/docs/images/event-stream-destinations/integration-key-pagerduty.webp)](</docs/images/event-stream-destinations/integration-key-pagerduty.webp>)