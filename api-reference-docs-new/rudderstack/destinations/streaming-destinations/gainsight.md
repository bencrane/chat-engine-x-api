...
Find the open source transformer code for this destination in the [GitHub repository](<https://github.com/rudderlabs/rudder-transformer/tree/master/src/v0/destinations/gainsight>).
...
---  
  ...
  * Refer to it as **Gainsight** in the [Integrations object](</docs/sources/event-streams/sdks/rudderstack-javascript-sdk/filtering/#filtering-destinations>).
...
[![](/docs/images/gainsightcs-settings.webp)](</docs/images/gainsightcs-settings.webp>)Connection screen for Gainsight
...
[![](/docs/images/gainsightcs-custom-field-person.webp)](</docs/images/gainsightcs-custom-field-person.webp>)gainsightcs-custom-field-person

Then, you can add the RudderStack trait name for the Gainsight custom field mapping in the RudderStack dashboard as shown:

[![](/docs/images/gainsightcs-person-map.webp)](</docs/images/gainsightcs-person-map.webp>)gainsightcs-field-map-person
...
[![](/docs/images/gainsightcs-custom-field-company.webp)](</docs/images/gainsightcs-custom-field-company.webp>)gainsightcs-custom-field-company

Then, you can add the RudderStack trait name for the Gainsight custom field mapping in the RudderStack dashboard:

[![](/docs/images/gainsightcs-company-map.webp)](</docs/images/gainsightcs-company-map.webp>)gainsightcs-field-map-company
...
[![](/docs/images/gainsightcs-event-main-settings.webp)](</docs/images/gainsightcs-event-main-settings.webp>)gainsight-event-main-settings
...
[![](/docs/images/gainsightcs-event-create.webp)](</docs/images/gainsightcs-event-create.webp>)gainsightcs-event-map-sample

Then, provide this event name and the version mapping in the RudderStack dashboard as shown:

[![](/docs/images/gainsightcs-event-map-sample.webp)](</docs/images/gainsightcs-event-map-sample.webp>)gainsightcs-event-map-sample
