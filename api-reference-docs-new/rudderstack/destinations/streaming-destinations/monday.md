...
Find the open source transformer code for this destination in the [GitHub repository](<https://github.com/rudderlabs/rudder-transformer/tree/master/src/v0/destinations/monday>).
...
---  
  ...
  * Refer to it as **Monday** in the [Integrations object](</docs/sources/event-streams/sdks/rudderstack-javascript-sdk/filtering/#filtering-destinations>).
...
[![Monday connection settings](/docs/images/event-stream-destinations/monday-connection-settings.webp)](</docs/images/event-stream-destinations/monday-connection-settings.webp>)
...
[![Monday connection settings](/docs/images/event-stream-destinations/monday-connection-settings-2.webp)](</docs/images/event-stream-destinations/monday-connection-settings-2.webp>)
...
[![Monday API token in the dashboard](/docs/images/event-stream-destinations/monday-api-token.webp)](</docs/images/event-stream-destinations/monday-api-token.webp>)
...
[![Monday dashboard](/docs/images/event-stream-destinations/monday-dashboard.webp)](</docs/images/event-stream-destinations/monday-dashboard.webp>)