...
[![](/docs/images/screenshot-2019-12-10-at-7.57.43-pm.webp)](</docs/images/screenshot-2019-12-10-at-7.57.43-pm.webp>)Move the Native SDK slider to enabled
...
## Where to Add Your Integration
  ...
  1. Add your integration under <https://github.com/rudderlabs/rudder-sdk-js/tree/production-staging/src/integrations> with the code as shown above in `browser.js` and an `index.js` for exporting the integration.
  2. Import the above integration in <https://github.com/rudderlabs/rudder-sdk-js/blob/production-staging/src/integrations/GA/index.js> and add it to the exported list to be picked up by the base RudderStack SDK.
...
[![](/docs/images/screenshot-2019-12-10-at-7.21.35-pm.webp)](</docs/images/screenshot-2019-12-10-at-7.21.35-pm.webp>) This exports the list of all native integrations

[![](/docs/images/screenshot-2019-12-10-at-7.22.25-pm.webp)](</docs/images/screenshot-2019-12-10-at-7.22.25-pm.webp>)This exports the GoogleAds integration
...
The following is the code for `index.js` under `integrations/GA/index.js` :
    ...
    // Ignore the node counter-part, we already have a seperate Node.js SDK
