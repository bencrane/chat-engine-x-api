# Integrate JavaScript SDK v1.1 with your Astro site
...
To set up the event stream on your Astro site, you need to perform the following steps:
  ...
  1. Integrate the JavaScript SDK with your Astro site and set up the tracking code
  2. Configure a destination in RudderStack
  3. Deploy your Astro site and verify the events
...
> 
> See the sample Astro site in the [RudderStack Sample Applications](<https://github.com/rudderlabs/rudder-samples/tree/master/javascript/sample-astro-site>) repository for more information.
