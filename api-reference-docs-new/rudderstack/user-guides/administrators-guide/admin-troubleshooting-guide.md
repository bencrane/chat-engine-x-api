...
## My Data Plane does not start. What should I do?
  ...
  2. Check if the Control Plane is up (<https://api.rudderlabs.com/health>)
...
## Gateway tables are not getting dumped
  ...
  * If there are tables that start with _``_ `pre _drop```_ but if you don’t see them being removed, verify the access credentials to your object storage like S3.
