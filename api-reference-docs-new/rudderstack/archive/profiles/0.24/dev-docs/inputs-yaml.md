...
The [`inputs.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.24/concepts/inputs/>) file contains the configuration of all input sources used in Profiles. This includes the ID graph, entity vars, feature view, etc.
...
[`ids`](<https://www.rudderstack.com/docs/archive/profiles/0.24/dev-docs/inputs-yaml/identifiers/>)  
...
[`s3`](<https://www.rudderstack.com/docs/archive/profiles/0.24/dev-docs/inputs-yaml/s3-bucket-input/>)| Amazon S3 URI path.  
  
## Video walkthrough

  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.24/dev-docs/profiles-yaml/cohorts/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.24/dev-docs/inputs-yaml/identifiers/>)