...
If you still face issues, you can try to install it manually. [Contact us](<mailto:support@rudderstack.com>) for the executable file and download it on your machine. Follow these steps afterwards:
...
Profiles support git branches in the RudderStack dashboard. Refer [Supported Git URLs](<https://www.rudderstack.com/docs/archive/profiles/0.24/additional-resources/git-url/>) for more information.
...
**What is the difference between`valid_at` and `first_seen_at` in the ID graph?**
...
You can use [ID Graph Cardinality Rules](<https://www.rudderstack.com/docs/archive/profiles/0.24/dev-docs/advanced-id-stitcher-features/id-graph-cardinality-rules/>) to limit connections between ID types.
...
Yes, refer to the [YAML best practices](<https://www.rudderstack.com/docs/archive/profiles/0.24/dev-docs/yaml-refresher/>) guide for detailed information.
...
You can check for the latest Profiles updates in the [changelog](<https://www.rudderstack.com/docs/archive/profiles/0.24/changelog/>).
...
After enabling SSO on GitHub, you must edit your Profiles project and deploy the updated SSH key. Also, make sure you are logged in to GitHub using SSO while doing that.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.24/additional-resources/glossary/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.24/changelog/>)