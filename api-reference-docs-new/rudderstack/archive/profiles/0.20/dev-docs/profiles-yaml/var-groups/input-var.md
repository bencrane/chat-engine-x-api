...
[`window`](<https://www.rudderstack.com/docs/archive/profiles/0.20/dev-docs/profiles-yaml/var-groups/window-functions/>)| Adds `partition_by` and/or `order_by` keys for window functions  
...
## Example
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.20/dev-docs/profiles-yaml/var-groups/entity-var/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.20/dev-docs/profiles-yaml/var-groups/window-functions/>)