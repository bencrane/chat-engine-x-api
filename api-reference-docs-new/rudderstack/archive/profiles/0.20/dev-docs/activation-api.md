...
##### [Activation API v1](</docs/archive/profiles/0.20/dev-docs/activation-api/v1/>)

Expose user profiles stored in your Redis instance over an API.

  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.20/dev-docs/warehouse-output/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.20/dev-docs/activation-api/v1/>)