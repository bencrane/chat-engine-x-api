...
## Prerequisites
  ...
  * [Create a warehouse connection](<https://www.rudderstack.com/docs/archive/profiles/0.20/overview/quickstart/#2-create-warehouse-connection>) file that Profiles uses to access your warehouse.
...
Once you exit the tutorial session and want to begin a a new Profiles project with your own data, follow this [Quickstart guide](<https://www.rudderstack.com/docs/archive/profiles/0.20/overview/quickstart/>) to get started.
...
#### When running the tutorial, I’m facing the error `rpc init: timeout waiting for python client to initialize`. How do I resolve this?

Tutorial is a PyNative model written in Python. Python code is first compiled into bytecode and is executed by the Python interpreter. Sometimes, compiling Python code takes more time than expected.

You can keep retrying the command and the error should resolve on its own.

#### I’m facing Python package related issues when trying out tutorial. How do I resolve them?
...
Make sure to pass the absolute path and not the relative path. For example:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.20/dev-docs/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.20/dev-docs/create-new-project/>)