...
You can define `inputs` in the [`inputs.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.20/dev-docs/inputs-yaml/>) file, as shown:
...
## Best practices
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.20/concepts/identity-graph/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.20/concepts/features/>)