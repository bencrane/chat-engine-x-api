...
## Requirements
  ...
  * An entity must have multiple IDs in the data sources, also called as [`inputs`](<https://www.rudderstack.com/docs/archive/profiles/0.20/concepts/inputs/>).
...
You can use`entities` in the [`pb_project.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.20/dev-docs/pb-project-yaml/>) file present in the top level of every Profiles project, as shown:
