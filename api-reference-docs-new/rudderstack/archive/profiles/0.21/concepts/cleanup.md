...
If you run the cleanup on the fourth day after the weekly model was run with a retention period of 3 days, then the cleanup will delete its materials, even though the [frontier views](<https://www.rudderstack.com/docs/archive/profiles/0.21/additional-resources/glossary/#frontier-views>) still need them.
...
You can specify the `retention_period` in the project as follows:
  ...
  * In the [`pb_project.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.21/dev-docs/pb-project-yaml/>):
...
This mode ensures that cleanup happens safely without unintentionally deleting materials that are still in use.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.21/concepts/sql-models/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.21/dev-docs/>)