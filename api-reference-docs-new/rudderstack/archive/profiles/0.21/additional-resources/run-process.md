...
When you exceute the `pb run` command to run your Profiles project, RudderStack performs these steps:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.21/additional-resources/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.21/additional-resources/multi-version/>)