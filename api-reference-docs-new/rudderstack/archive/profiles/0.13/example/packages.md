...
`value`| String| Contains the reusable function in the form of a SQL expression. Any reference to the inputs must be encapsulated within double curly brackets.  
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.13/example/predictive-features-snowflake/custom-code/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.13/changelog/>)