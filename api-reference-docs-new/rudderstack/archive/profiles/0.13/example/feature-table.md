...
To create feature tables for the entire set of an entity’s instance, specify the `entity_key`:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.13/example/id-collator/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.13/example/feature-views/>)