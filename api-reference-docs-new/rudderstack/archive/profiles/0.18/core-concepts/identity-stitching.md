...
## Notable features
  ...
  * Use different input sources like RudderStack’s [Event Stream](<https://www.rudderstack.com/docs/sources/event-streams/>) or any existing tables in the warehouse.
...
#### See also
  ...
  * [Sample identity stitching project](<https://www.rudderstack.com/docs/archive/profiles/0.18/example/id-stitcher/>)
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.18/core-concepts/data-modeling/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.18/core-concepts/feature-development/>)