...
See also: [Setup and installation FAQ](<https://www.rudderstack.com/docs/archive/profiles/0.18/faq/#setup-and-installation>)
...
Then, continue with the connection setup by specifying the below settings:
  ...
  * **Append to site configuration file** : Determines whether to add the connection details to the [`siteconfig.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.18/cli-user-guide/structure/#site-configuration-file>) file.
...
A sample connection for a Databricks account is as follows:
    ...
    Enter user: profiles_test_user # (Optional) Username of your Databricks account.
    Enter schema: rs_profiles # A segregated schema for storing tables/views created by Profiles
...
> ![info](/docs/images/info.svg)
> 
> RudderStack currently supports Databricks only with Azure cloud platform. To get the Databricks connection details:
> 
...
This creates a local [site configuration file](<https://www.rudderstack.com/docs/archive/profiles/0.18/cli-user-guide/structure/>) inside your home directory: `~/.pb/siteconfig.yaml`. Your Profiles project uses this file to access the warehouse, git credentials, and other details. If you don’t see the file, enable the **View hidden files** option.
...
See [Project structure](<https://www.rudderstack.com/docs/archive/profiles/0.18/cli-user-guide/structure/>) for more information on the PB project files.
...
See [Project structure](<https://www.rudderstack.com/docs/archive/profiles/0.18/cli-user-guide/structure/#inputs>) for more information on setting these values.
...
If there are no errors, proceed to the next step. In case of errors, check if your warehouse schemas and tables have the [required permissions](<https://www.rudderstack.com/docs/archive/profiles/0.18/permissions/>).
...
Run the project and generate [material tables](<https://www.rudderstack.com/docs/archive/profiles/0.18/resources/glossary/#material-tables>):
...
You can run the `pb show models` command to get the exact name and path of the generated ID stitcher/feature table. See [show](<https://www.rudderstack.com/docs/archive/profiles/0.18/cli-user-guide/commands/#show>) command for more information.
...
To migrate an existing PB project to the [schema version](<https://www.rudderstack.com/docs/archive/profiles/0.18/resources/glossary/#schema-versions>) supported by your PB binary, navigate to your project’s folder. Then, run the following command to replace the contents of the existing folder with the new one:
...
A confirmation message appears on screen indicating that the migration is complete. A sample message for a user migrating their project from version 25 to 44:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.18/get-started/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.18/get-started/quickstart-ui/>)