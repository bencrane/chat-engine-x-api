...
> Note how `frame_clause` is specified in first `entity_var` and not in the second one.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.11/example/id-collator/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.11/example/entity-traits-360/>)