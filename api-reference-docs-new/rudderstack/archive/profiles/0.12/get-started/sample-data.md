...
This data set contains a total of ~10k unique users by `anonymousId`. About half of these unique users (~4.8k) are known users (with an associated `identify` call).
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.12/get-started/import-from-git/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.12/core-concepts/>)