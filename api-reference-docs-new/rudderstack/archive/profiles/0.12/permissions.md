...
> For BigQuery, RudderStack recommends you to use a view instead of table for streaming data sets.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.12/core-concepts/feature-development/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.12/cli-user-guide/>)