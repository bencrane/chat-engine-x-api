...
Create user features using SQL models:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.14/example/feature-views/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.14/example/predictive-features-snowflake/>)