...
> 
> RudderStack strongly recommends using an isolated and clean [Python virtual environment](<https://www.rudderstack.com/docs/archive/profiles/0.19/dev-docs/create-new-project/#create-virtual-environment>).

  * Update your `pb_project.yaml` file to include the library:
        
        python_requirements:
          - profiles_mlcorelib>=0.6.0
...
If you have created your Profiles project locally, run it using the [`pb run` CLI command](<https://www.rudderstack.com/docs/archive/profiles/0.19/dev-docs/run-project/>) to generate the output tables.
...
Although there is no universal _good_ score for model evaluation metrics, RudderStack uses a few guidelines:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.19/data-apps/attribution/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.19/data-apps/real-time-personalization/>)