...
> 
> Profiles ID Stitcher Audit tool is only available in PB version 0.19.0 and above.
...
## Prerequisites
  ...
  * Generate a [workspace-level Service Access Token](<https://www.rudderstack.com/docs/access-management/service-access-tokens/#workspace-sat>) in your RudderStack dashboard with the [relevant permissions](<https://www.rudderstack.com/docs/access-management/policies-overview/#resource-permissions>) to manage Profiles.
...
> See [this documentation](<https://www.rudderstack.com/docs/archive/dashboard-guides/service-access-tokens/#generate-service-access-token>) for more information.
  ...
  * Add the token to your [site configuration](<https://www.rudderstack.com/docs/archive/profiles/0.19/dev-docs/site-configuration-file/>) under the `rudderstack_access_token` key (similar to the `connections` key).
...
You can add a line `telemetry_opted_out: true` in this preference file to **opt out** of tracking.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.19/additional-resources/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.19/additional-resources/run-process/>)