...
This dataset contains a total of ~10k unique users by `anonymousId`. About 5.8k of these unique users are known users (with an associated `identify` call).
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.19/additional-resources/multi-version/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.19/additional-resources/git-url/>)