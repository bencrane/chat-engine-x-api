...
Validate Profile Builder’s version after installing:
  ...
  * If you are an existing user, [migrate your project](<https://www.rudderstack.com/docs/archive/profiles/0.19/dev-docs/commands/#migrate>) to the new schema.
  * See the [Profiles setup and installation FAQ](<https://www.rudderstack.com/docs/archive/profiles/0.19/additional-resources/faq/#setup-and-installation>) for troubleshooting any issues.
...
Then, continue with the connection setup by specifying the below settings:
  ...
  * **Append to site configuration file** : Determines whether to add the connection details to the [`siteconfig.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.19/dev-docs/site-configuration-file/>) file.
...
This creates a local [site configuration file](<https://www.rudderstack.com/docs/archive/profiles/0.19/dev-docs/site-configuration-file/>) in your home directory: `~/.pb/siteconfig.yaml`. Your Profiles project uses this file to access the warehouse, Git credentials, and other details. If you don’t see the file, enable the **View hidden files** option.
...
See [Project structure](<https://www.rudderstack.com/docs/archive/profiles/0.19/dev-docs/project-structure/>) for more information on the Profiles project files.

  


  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.19/dev-docs/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.19/dev-docs/project-structure/>)