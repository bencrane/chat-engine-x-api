...
No, it’s not possible to modify the Git repository URL of an existing Profiles project. However, you can always create a new project with the required Git URL.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.19/dev-docs/site-configuration-file/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.19/dev-docs/pb-project-yaml/>)