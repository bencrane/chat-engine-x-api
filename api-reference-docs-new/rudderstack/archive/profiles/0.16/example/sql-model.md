...
> 
> A `multi_sql` type SQL model only creates a table as an output type in a warehouse whereas `single_sql` type SQL model supports all the output types (deafult is `ephemeral`). See [materialization](<https://www.rudderstack.com/docs/archive/profiles/0.16/resources/glossary/#materialization>) for more information.
...
Create user features using SQL models:
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.16/example/feature-views/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.16/example/predictive-features-snowflake/>)