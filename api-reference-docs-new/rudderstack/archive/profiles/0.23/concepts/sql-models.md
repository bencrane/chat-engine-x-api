...
You can define SQL models in the [`sql_model.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/sql-model-yaml/>) file, as shown:
...
## Best practices
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/concepts/timegrains/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/concepts/cleanup/>)