...
The `pb_project.yaml` file contains the overall project configuration. This includes the [`entities`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/pb-project-yaml/entities/>) and [`id_types`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/pb-project-yaml/id-types/>) that are used throughout the project.
...
`connection`  
Required| Connection name from [`siteconfig.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/site-configuration-file/>).  
`model_folders`  
Required| Path to the folder containing the model files.  
[`entities`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/pb-project-yaml/entities/>)  
...
## Example
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/dev-docs/ide/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/dev-docs/pb-project-yaml/entities/>)