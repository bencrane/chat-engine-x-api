...
`model_spec` defines SQL queries, how the table is created, and any [`ids`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/inputs-yaml/identifiers/>) and [`entities`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/pb-project-yaml/entities/>) for the table.
...
[`ids`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/inputs-yaml/identifiers/>)| Define the ID fields, `select`, `id_types`, and related `entity` parameters.  
...
## Example
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/dev-docs/sql-model-yaml/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/dev-docs/macros-yaml/>)