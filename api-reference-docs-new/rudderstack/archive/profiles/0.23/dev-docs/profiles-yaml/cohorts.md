...
You can define [cohorts](<https://www.rudderstack.com/docs/archive/profiles/0.23/concepts/cohort/>) along with any associated features and feature views in the [`profiles.yaml`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/profiles-yaml/>) file.
...
You can view the output for cohorts in the **Entities** tab of the UI once you [import a Profiles project from Git](<https://www.rudderstack.com/docs/archive/profiles/0.23/management/import-from-git/>) and run it.
...
> Contact the Profiles support team in RudderStack’s [Community Slack](<https://rudderstack.com/join-rudderstack-slack-community>) if you are unable to see the **Entities** tab.
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/dev-docs/profiles-yaml/var-groups/window-functions/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/dev-docs/inputs-yaml/>)