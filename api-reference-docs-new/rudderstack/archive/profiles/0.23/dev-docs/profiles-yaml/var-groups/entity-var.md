...
[`window`](<https://www.rudderstack.com/docs/archive/profiles/0.23/dev-docs/profiles-yaml/var-groups/window-functions/>)| Adds `order_by` key for window functions. Rows are automatically partitioned by `rudder_id`.  
...
## Example
  ...
  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.23/dev-docs/profiles-yaml/var-groups/input-var/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.23/dev-docs/profiles-yaml/var-groups/window-functions/>)