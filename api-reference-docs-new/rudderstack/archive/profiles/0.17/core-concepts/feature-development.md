...
Further, you can combine the features to create even more features or use [custom SQL queries](<https://www.rudderstack.com/docs/archive/profiles/0.17/example/sql-model/>) to enrich unified user profiles for advanced use cases.
...
#### See also
  ...
  * [Sample feature view project](<https://www.rudderstack.com/docs/archive/profiles/0.17/example/feature-views/>)
  * [Sample SQL model project](<https://www.rudderstack.com/docs/archive/profiles/0.17/example/sql-model/>)


  * [![](/docs/images/previous.svg)Previous](</docs/archive/profiles/0.17/core-concepts/identity-stitching/>)
  * [Next ![](/docs/images/next.svg)](</docs/archive/profiles/0.17/permissions/>)