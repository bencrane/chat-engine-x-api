...
This page contains all 534 accepted industry values for the `industry` filter. BlitzAPI uses LinkedIn's industry taxonomy.
...
- Note: some values use semicolons as separators (e.g. `"Technology; Information and Internet"`)
...
*Source: BlitzAPI industry values reference (534 values)*
