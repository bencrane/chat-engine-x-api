...
Documentation for the `EmailAddressRoleConnection` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Connection
- **URL Slug**: `email-address-role-connection`
...
[EmailAddressRoleConnection Documentation](https://documentation.enigma.com/reference/graphql_api/objects/email-address-role-connection)
