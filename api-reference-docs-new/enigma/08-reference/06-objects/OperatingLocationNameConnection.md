...
Documentation for the `OperatingLocationNameConnection` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Connection
- **URL Slug**: `operating-location-name-connection`
...
[OperatingLocationNameConnection Documentation](https://documentation.enigma.com/reference/graphql_api/objects/operating-location-name-connection)
