...
Documentation for the `LegalEntityTinConnection` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Connection
- **URL Slug**: `legal-entity-tin-connection`
...
[LegalEntityTinConnection Documentation](https://documentation.enigma.com/reference/graphql_api/objects/legal-entity-tin-connection)
