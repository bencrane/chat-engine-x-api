...
Documentation for the `RoleOperatingLocationEdge` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Edge
- **URL Slug**: `role-operating-location-edge`
...
[RoleOperatingLocationEdge Documentation](https://documentation.enigma.com/reference/graphql_api/objects/role-operating-location-edge)
