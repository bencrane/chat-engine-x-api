...
Documentation for the `RoleRegistrationConnection` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Connection
- **URL Slug**: `role-registration-connection`
...
[RoleRegistrationConnection Documentation](https://documentation.enigma.com/reference/graphql_api/objects/role-registration-connection)
