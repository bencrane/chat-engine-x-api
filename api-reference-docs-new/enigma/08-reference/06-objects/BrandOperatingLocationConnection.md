...
Documentation for the `BrandOperatingLocationConnection` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Connection
- **URL Slug**: `brand-operating-location-connection`
...
[BrandOperatingLocationConnection Documentation](https://documentation.enigma.com/reference/graphql_api/objects/brand-operating-location-connection)
