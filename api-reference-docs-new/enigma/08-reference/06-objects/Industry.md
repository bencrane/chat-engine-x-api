...
Documentation for the `Industry` GraphQL object type in the Enigma API.
...
[Industry Documentation](https://documentation.enigma.com/reference/graphql_api/objects/industry)
