...
Documentation for the `RegistrationRoleConnection` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Connection
- **URL Slug**: `registration-role-connection`
...
[RegistrationRoleConnection Documentation](https://documentation.enigma.com/reference/graphql_api/objects/registration-role-connection)
