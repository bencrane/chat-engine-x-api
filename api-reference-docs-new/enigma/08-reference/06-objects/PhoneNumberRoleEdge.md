...
Documentation for the `PhoneNumberRoleEdge` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Edge
- **URL Slug**: `phone-number-role-edge`
...
[PhoneNumberRoleEdge Documentation](https://documentation.enigma.com/reference/graphql_api/objects/phone-number-role-edge)
