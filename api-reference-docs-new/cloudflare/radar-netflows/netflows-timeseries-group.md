...
- **dimension** (string, required) [path]: Specifies the NetFlows attribute by which to group the results.
...
- **product** (array, optional) [query]: Filters the results by network traffic product types.
