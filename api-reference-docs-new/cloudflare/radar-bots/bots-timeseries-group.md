...
- **bot** (array, optional) [query]: Filters results by bot name.
- **botOperator** (array, optional) [query]: Filters results by bot operator.
- **botCategory** (array, optional) [query]: Filters results by bot category.
- **botKind** (array, optional) [query]: Filters results by bot kind.
- **botVerificationStatus** (array, optional) [query]: Filters results by bot verification status (Verified vs. Unverified).
