---
title: "getUsage()"
url: "https://www.remotion.dev/docs/licensing/get-usage"
path: "/docs/licensing/get-usage"
---
...
Get the current usage of your licenseimport {getUsage} from '@remotion/licensing';
...
### `webRenders`[v4.0.428](https://github.com/remotion-dev/remotion/releases/v4.0.428)[​](#webrenders)
...
- [`registerUsageEvent()`](/docs/licensing/register-usage-event)
](/docs/licensing/register-usage-event)](/docs/licensing/register-usage-event)
](/docs/licensing/register-usage-event)
- ](/docs/licensing/register-usage-event)
- ](/docs/licensing/register-usage-event)
- ](/docs/licensing/register-usage-event)
- ](/docs/licensing/register-usage-event)
