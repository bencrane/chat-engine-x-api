...
| trust_product_sid | SID<BU> | Optional | Not PII | The unique string that we created to identify the CustomerProfile resource. Pattern: `^BU[0-9a-fA-F]{32}$` Min length: 34, Max length: 34 |
...
| Property name | Type | Required | PII | Description |
|---------------|------|----------|-----|-------------|
| trust_product_sid | SID<BU> | required | Not PII | The unique string that we created to identify the CustomerProfile resource. Pattern: `^BU[0-9a-fA-F]{32}$` Min length: 34, Max length: 34 |
