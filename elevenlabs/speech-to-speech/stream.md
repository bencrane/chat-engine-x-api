    ...
    post:
      ...
      parameters:
        ...
        - name: output_format
          ...
          schema:
            $ref: >-
              #/components/schemas/type_speechToSpeech:SpeechToSpeechStreamRequestOutputFormat
        - name: xi-api-key
          in: header
          required: false
          schema:
          ...
          multipart/form-data:
            schema:
              ...
              properties:
                ...
                file_format:
                  $ref: >-
                    #/components/schemas/type_speechToSpeech:SpeechToSpeechStreamRequestFileFormat
                  description: >-
...
components:
  schemas:
    type_speechToSpeech:SpeechToSpeechStreamRequestOutputFormat:
      type: string
      enum:
        - mp3_22050_32
        - mp3_24000_48
      ...
      title: SpeechToSpeechStreamRequestOutputFormat
    type_speechToSpeech:SpeechToSpeechStreamRequestFileFormat:
      type: string
      enum:
        - pcm_s16le_16
        - other
      title: SpeechToSpeechStreamRequestFileFormat
