---
title: "loadFont()"
url: "https://www.remotion.dev/docs/google-fonts/load-font"
path: "/docs/google-fonts/load-font"
---
...
Load one style, weight and subsetimport {loadFont} from '@remotion/google-fonts/Lobster';
import {AbsoluteFill} from 'remotion';
