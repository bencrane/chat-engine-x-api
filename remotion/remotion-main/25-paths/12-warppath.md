---
title: "warpPath()"
url: "https://www.remotion.dev/docs/paths/warp-path"
path: "/docs/paths/warp-path"
---
...
warp-path.tsimport { warpPath, WarpPathFn } from "@remotion/paths";
...
- [Source code for this function](https://github.com/remotion-dev/remotion/blob/main/packages/paths/src/warp-path/index.ts)
](https://github.com/remotion-dev/remotion/blob/main/packages/paths/src/warp-path/index.ts)](https://github.com/remotion-dev/remotion/blob/main/packages/paths/src/warp-path/index.ts)
](https://github.com/remotion-dev/remotion/blob/main/packages/paths/src/warp-path/index.ts)
- ](https://github.com/remotion-dev/remotion/blob/main/packages/paths/src/warp-path/index.ts)
- ](https://github.com/remotion-dev/remotion/blob/main/packages/paths/src/warp-path/index.ts)
- ](https://github.com/remotion-dev/remotion/blob/main/packages/paths/src/warp-path/index.ts)
- ](https://github.com/remotion-dev/remotion/blob/main/packages/paths/src/warp-path/index.ts)
