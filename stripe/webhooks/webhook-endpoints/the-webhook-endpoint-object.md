...
- #### secretstringThe endpoint’s secret, used to generate [webhook signatures](https://docs.stripe.com/webhooks/signatures). Only returned at creation.
- #### statusstringThe status of the webhook. It can be enabled or disabled.
- #### urlstringThe URL of the webhook endpoint.
### More attributesExpand all- #### objectstring- #### applicationnullable string- #### createdtimestamp- #### livemodebooleanThe Webhook Endpoint object```
