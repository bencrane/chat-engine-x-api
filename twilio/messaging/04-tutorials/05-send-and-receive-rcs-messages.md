...
> **Beta**
> If you're interested in sending rich content on RCS without using a Content Template, you can request access to the private beta of the Communications API.
