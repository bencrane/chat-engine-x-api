...
Want to keep your existing phone number? **Check if your number is portable** using the Console, or learn about **porting with the API**.

Not a developer? Check out our **Phone Numbers product page** for features, capabilities, and more information.
...
For detailed implementation guidance, see the **Messaging documentation** and explore the messaging service configuration options. Learn more about **default sender ID configuration** for your messaging services.

---

> **Info**
> If you're an Australian Consumer customer, the **Twilio Critical Information Summary (CIS)** is available.

> **Warning**
> Several Phone Number products are in developer preview. Follow the links below to request early access:
> - **Global Phone Numbers Catalog API**
> - **Hosted SMS**
...
- **Search for and buy available numbers**
- **Manage your Twilio phone numbers**
- Read our recommended **best practices for phone number usage**

### Get started with the Hosted Numbers API (developer preview)

- **Hosted SMS Quickstart**
- **Hosted Phone Numbers API reference**
- **FAQ**

### Check out the documentation for the Global Phone Numbers Catalog (in developer preview)

- **Global Phone Numbers Catalog overview**
- **AvailableNumbers**
- **FAQ**