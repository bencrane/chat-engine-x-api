...
> Use the Bright Data Playground API to test and unlock websites in real time, bypassing anti-bot protections while automatically managing proxies and CAPTCHAs.

Related guide: [Playground API Introduction](/scraping-automation/web-unlocker/introduction)
