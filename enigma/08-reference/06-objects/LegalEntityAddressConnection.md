...
Documentation for the `LegalEntityAddressConnection` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Connection
- **URL Slug**: `legal-entity-address-connection`
...
[LegalEntityAddressConnection Documentation](https://documentation.enigma.com/reference/graphql_api/objects/legal-entity-address-connection)
