...
Documentation for the `PersonLegalEntityConnection` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Connection
- **URL Slug**: `person-legal-entity-connection`
...
[PersonLegalEntityConnection Documentation](https://documentation.enigma.com/reference/graphql_api/objects/person-legal-entity-connection)
