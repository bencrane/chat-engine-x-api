...
Documentation for the `LegalEntityBankruptcy` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Attribute
- **URL Slug**: `legal-entity-bankruptcy`
...
[LegalEntityBankruptcy Documentation](https://documentation.enigma.com/reference/graphql_api/objects/legal-entity-bankruptcy)
