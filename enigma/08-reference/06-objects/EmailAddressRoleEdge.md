...
Documentation for the `EmailAddressRoleEdge` GraphQL object type in the Enigma API.

## Type Information

- **Category**: Edge
- **URL Slug**: `email-address-role-edge`
...
[EmailAddressRoleEdge Documentation](https://documentation.enigma.com/reference/graphql_api/objects/email-address-role-edge)
