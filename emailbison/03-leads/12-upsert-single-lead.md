...
info:
  ...
  version: 1.0.0
paths:
  /api/leads/create-or-update/{lead_id}:
    post:
      summary: Update or create lead
      deprecated: false
      description: 'Update the details of a specific lead if it exists, otherwise create a new record.'
      tags:
        - Leads
      parameters:
        - name: lead_id
          ...
          schema:
            type: integer
          description: 'The ID of the lead to update or create.'
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                existing_lead_behavior:
                  type: string
                  description: >-
                    The behavior to apply if the lead exists.
