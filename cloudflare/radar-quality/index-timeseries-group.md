...
- **interpolation** (boolean, optional) [query]: Enables interpolation for all series (using the average).
- **metric** (string, required) [query]: Defines which metric to return (bandwidth, latency, or DNS response time).
