...
- **crawlPurpose** (array, optional) [query]: Filters results by bot crawl purpose.
- **userAgent** (array, optional) [query]: Filters results by user agent.
- **industry** (array, optional) [query]: Filters results by industry.
- **vertical** (array, optional) [query]: Filters results by vertical.
- **contentType** (array, optional) [query]: Filters results by content type category.
