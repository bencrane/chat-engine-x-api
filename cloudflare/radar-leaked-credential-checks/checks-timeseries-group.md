...
- **compromised** (array, optional) [query]: Filters results by compromised credential status (clean vs. compromised).
- **checkResult** (array, optional) [query]: Filters results by leaked credential check result.
